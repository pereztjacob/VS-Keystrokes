...
const lineMove = new ShortCut(['alt', 'down'], 'Moves current line down. If there is a line directly below current line they swap places. Use the up arrow to perform the opposite effect.', 'img/altDown.gif', [18, 40]);
